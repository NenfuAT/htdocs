...
<?php
    ...
    switch($areanum){
        case 1: //南米
            $strlistbox = "<select size='3' name='team' onclick='document.muform.submit();'>
            ...
            break;
        case 2: //ヨーロッパ
            $strlistbox = "<select size='4' name='team' onclick='document.muform.submit();'>
            ...
            break;
        case 3: //アフリカ
            $strlistbox = "<select size='2' name='team' onclick='document.muform.submit();'>
